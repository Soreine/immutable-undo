...
class History extends new Record(DEFAULTS) {
    ...
    prune() {
        ...
        case SMOOTH:
            const maxMerge = this.undos.first().merged;
            const minMerge = this.undos.last().merged;
            const size = this.undos.count();
            ...
            let receivingIndex = this.undos.findIndex(
        ...
        case LRU:
        default:
            return this.set('undos', this.undos.shift());
        }
    }
}
